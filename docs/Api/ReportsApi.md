...
```php
createReport($body): \Ced\Mcf\Model\CreateReportResponse
```
...
$body = new \Ced\Mcf\Model\CreateReportSpecification(); // \Ced\Mcf\Model\CreateReportSpecification
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\Ced\Mcf\Model\CreateReportSpecification**](../Model/CreateReportSpecification.md)|  | |

### Return type

[**\Ced\Mcf\Model\CreateReportResponse**](../Model/CreateReportResponse.md)
...
```php
createReportSchedule($body): \Ced\Mcf\Model\CreateReportScheduleResponse
```
...
$body = new \Ced\Mcf\Model\CreateReportScheduleSpecification(); // \Ced\Mcf\Model\CreateReportScheduleSpecification
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\Ced\Mcf\Model\CreateReportScheduleSpecification**](../Model/CreateReportScheduleSpecification.md)|  | |

### Return type

[**\Ced\Mcf\Model\CreateReportScheduleResponse**](../Model/CreateReportScheduleResponse.md)
...
```php
getReport($report_id): \Ced\Mcf\Model\Report
```
...
[**\Ced\Mcf\Model\Report**](../Model/Report.md)
...
```php
getReportDocument($report_document_id): \Ced\Mcf\Model\ReportDocument
```
...
[**\Ced\Mcf\Model\ReportDocument**](../Model/ReportDocument.md)
...
```php
getReportSchedule($report_schedule_id): \Ced\Mcf\Model\ReportSchedule
```
...
[**\Ced\Mcf\Model\ReportSchedule**](../Model/ReportSchedule.md)
...
```php
getReportSchedules($report_types): \Ced\Mcf\Model\ReportScheduleList
```
...
[**\Ced\Mcf\Model\ReportScheduleList**](../Model/ReportScheduleList.md)
...
```php
getReports($report_types, $processing_statuses, $marketplace_ids, $page_size, $created_since, $created_until, $next_token): \Ced\Mcf\Model\GetReportsResponse
```
...
[**\Ced\Mcf\Model\GetReportsResponse**](../Model/GetReportsResponse.md)
