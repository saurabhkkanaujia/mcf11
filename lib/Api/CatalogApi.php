...
/**
     ...
     * @return \Ced\Mcf\Model\Item|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList
     */
    public function getCatalogItem($asin, $marketplace_ids, $included_data = null, $locale = null, string $contentType = self::contentTypes['getCatalogItem'][0])
    {
        list($response) = $this->getCatalogItemWithHttpInfo($asin, $marketplace_ids, $included_data, $locale, $contentType);
        return $response;
    }
     ...
     * @throws \Ced\Mcf\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ced\Mcf\Model\Item|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCatalogItemWithHttpInfo($asin, $marketplace_ids, $included_data = null, $locale = null, string $contentType = self::contentTypes['getCatalogItem'][0])
    {
        $request = $this->getCatalogItemRequest($asin, $marketplace_ids, $included_data, $locale, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ced\Mcf\Model\Item' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ced\Mcf\Model\Item' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Ced\Mcf\Model\Item', []),
     ...
     */
    public function getCatalogItemAsync($asin, $marketplace_ids, $included_data = null, $locale = null, string $contentType = self::contentTypes['getCatalogItem'][0])
    {
        return $this->getCatalogItemAsyncWithHttpInfo($asin, $marketplace_ids, $included_data, $locale, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCatalogItemAsyncWithHttpInfo($asin, $marketplace_ids, $included_data = null, $locale = null, string $contentType = self::contentTypes['getCatalogItem'][0])
    {
        $returnType = '\Ced\Mcf\Model\Item';
        $request = $this->getCatalogItemRequest($asin, $marketplace_ids, $included_data, $locale, $contentType);
     ...
     */
    public function getCatalogItemRequest($asin, $marketplace_ids, $included_data = null, $locale = null, string $contentType = self::contentTypes['getCatalogItem'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchCatalogItems'] to see the possible values for this operation
     *
     * @throws \Ced\Mcf\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ced\Mcf\Model\ItemSearchResults|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList
     */
    public function searchCatalogItems($marketplace_ids, $identifiers = null, $identifiers_type = null, $included_data = null, $locale = null, $seller_id = null, $keywords = null, $brand_names = null, $classification_ids = null, $page_size = 10, $page_token = null, $keywords_locale = null, string $contentType = self::contentTypes['searchCatalogItems'][0])
    {
        list($response) = $this->searchCatalogItemsWithHttpInfo($marketplace_ids, $identifiers, $identifiers_type, $included_data, $locale, $seller_id, $keywords, $brand_names, $classification_ids, $page_size, $page_token, $keywords_locale, $contentType);
        return $response;
    }
     ...
     * @throws \Ced\Mcf\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ced\Mcf\Model\ItemSearchResults|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList|\Ced\Mcf\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchCatalogItemsWithHttpInfo($marketplace_ids, $identifiers = null, $identifiers_type = null, $included_data = null, $locale = null, $seller_id = null, $keywords = null, $brand_names = null, $classification_ids = null, $page_size = 10, $page_token = null, $keywords_locale = null, string $contentType = self::contentTypes['searchCatalogItems'][0])
    {
        $request = $this->searchCatalogItemsRequest($marketplace_ids, $identifiers, $identifiers_type, $included_data, $locale, $seller_id, $keywords, $brand_names, $classification_ids, $page_size, $page_token, $keywords_locale, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ced\Mcf\Model\ItemSearchResults' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ced\Mcf\Model\ItemSearchResults' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Ced\Mcf\Model\ItemSearchResults', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Ced\Mcf\Model\ItemSearchResults';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ced\Mcf\Model\ItemSearchResults',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchCatalogItemsAsync($marketplace_ids, $identifiers = null, $identifiers_type = null, $included_data = null, $locale = null, $seller_id = null, $keywords = null, $brand_names = null, $classification_ids = null, $page_size = 10, $page_token = null, $keywords_locale = null, string $contentType = self::contentTypes['searchCatalogItems'][0])
    {
        return $this->searchCatalogItemsAsyncWithHttpInfo($marketplace_ids, $identifiers, $identifiers_type, $included_data, $locale, $seller_id, $keywords, $brand_names, $classification_ids, $page_size, $page_token, $keywords_locale, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchCatalogItemsAsyncWithHttpInfo($marketplace_ids, $identifiers = null, $identifiers_type = null, $included_data = null, $locale = null, $seller_id = null, $keywords = null, $brand_names = null, $classification_ids = null, $page_size = 10, $page_token = null, $keywords_locale = null, string $contentType = self::contentTypes['searchCatalogItems'][0])
    {
        $returnType = '\Ced\Mcf\Model\ItemSearchResults';
        $request = $this->searchCatalogItemsRequest($marketplace_ids, $identifiers, $identifiers_type, $included_data, $locale, $seller_id, $keywords, $brand_names, $classification_ids, $page_size, $page_token, $keywords_locale, $contentType);
